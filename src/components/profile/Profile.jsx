...
const Profile = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#3f1473] to-[#8a63bb] min-h-screen flex items-center justify-center p-4">
      <div className="font-std mb-10 w-[95%] rounded-2xl bg-white p-10 font-normal leading-relaxed text-gray-900 shadow-xl mt-10 ">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/3 text-center mb-8 md:mb-0">
            <img src={user.image} alt="Profile Picture" class="rounded-full w-48 h-48 mx-auto mb-4 border-4 border-[#3f1473] transition-transform duration-300 hover:scale-105 ring ring-gray-300" />
