      ...
      <div className=" overflow-x-hidden  flex flex-col justify-center items-center">
        ...
        <div className="max-w-3xl mx-auto p-6 bg-white shadow-md rounded-lg">
          ...
          <ul className="list-disc list-inside mt-2">
            ...
            <li><strong>Membership Period:</strong> Membership runs annually from April 1st to March 31st, regardless of when the application is submitted during the year.</li>
          ...
          <p><strong>Mandatory Jurisdiction:</strong> If any member files a legal claim against AIDEOA, they must first proceed with the application in the Dhanbad Court. If a case is filed in any other court, the user accepts, as per these Terms and Conditions, that they cannot proceed with legal action elsewhere and must file their case in Dhanbad Court only.</p>
